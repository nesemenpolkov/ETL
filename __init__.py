...
if __name__ == "__main__":
    ...
    try:
        test1 = Extractor(service="youtube", api_key="AIzaSyAGMaR0IEOVRVgvLkaTt6wtSiiv-IWhyic")
        ...
        test1.monitor(channels=test_sample, interval=300, duration=48, delta=900)
        test1.run(isBackground=True)
